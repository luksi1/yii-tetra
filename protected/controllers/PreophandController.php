<?php
class PreophandController extends Controller
{
	public $layout='//layouts/column1';
	
	public function actionIndex()
	{
		$dataProvider=new CActiveDataProvider('Preophand');
	...
	public function accessRules()
	{
        ...
        public function actionCreate()
        {
            $model=new Preophand;
                ...
                if(isset($_POST['Preophand']))
                {
                        $model->attributes=$_POST['Preophand'];
                        if($model->save())
...
*/
	...
	public function actionUpdate($pnr, $operations_datum)
	{
		...
		if(isset($_POST['Preophand']))
		{
			...
			$this->redirect(array('view',
	                    'personnummer'=>$model->personnummer, 'operations_datum'=>$model->operations_datum,'befolkningsinfo'=>$befolkningsinfo,'operations'=>$operations));
		}
	...
	{
		$model=new Preophand('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Preophand']))
			$model->attributes=$_GET['Preophand'];
	...
	{
		$model=Preophand::model()->findByPk(array('personnummer'=>$personnummer, 'operations_datum'=>$operations_datum));
		if($model==null)
